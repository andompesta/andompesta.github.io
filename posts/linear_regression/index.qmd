...
$$
\begin{align}
\frac{\partial \mathcal{L}(y, \hat{y})}{\partial \rvw} = & \frac{\partial || \rvy - \rmX \rvw ||^2}{\partial \rvw} \\
& = 2\rmX^T (\rvy - \rmX \rvw) \\
...
$$
y = \epsilon + w_0 + w_1 x_1 + ... + w_k x_k + \lambda \sum_{1 \leq i \leq k} w_i^2.
$$
...
$$
y = \epsilon + w_0 + w_1 x_1 + ... + w_k x_k + \lambda \sum_{1 \leq i \leq k} |w_i|.
$$
