...
For any given line represented by the equation $ax ~~ + ~~ by = 0$, the formalization of the orthogonal distance between this line and a specific point $(x_i, y_i)$ is expressed as follows:
