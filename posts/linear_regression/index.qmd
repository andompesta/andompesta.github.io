...
Thus, the optimal parameter of a total least square model are equivalent to the eigenvector assocaite to the smallest eigenvalue of the matrix $\rmZ^T \rmZ$.
